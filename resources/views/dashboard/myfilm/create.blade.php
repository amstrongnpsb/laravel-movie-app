...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom"
        ...
        <h1 class="h2">Register New Film</h1>
    </div>
    <div class="col-lg-8">
        <form method="post" action="/dashboard/myfilm" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="director_id">
                    ...
                    @if(old('director_id') == $director->id)
            ...
            <div class="mb-3">
                ...
                @enderror
                <input id="full_sinopsis" type="hidden" name="full_sinopsis" value="{{ old('full_sinopsis') }}">
